...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initWithTsIgnore((_a = test2.param) !== null && _a !== void 0 ? _a : `Undefined Placeholder via nullish coalescing operator`); // provide a default value when dealing with null or undefined. It checks if the left-hand side operand is null or undefined, and if so, it returns the right-hand side operand. Otherwise, it returns the left-hand side operand. Use when you want to provide a fallback value for null or undefined. Only considers null and undefined as nullish values.
